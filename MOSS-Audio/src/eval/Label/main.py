...
from eval_raw_output_batch import eval_raw_output, load_model_and_processor
...
DEFAULT_MODEL_PATH = "path/to/MOSS-Audio-8B-Thinking"
...
def main():
    ...
    print(f"vote_output_csv_total_samples: {vote_info['total_samples']}")
    print(f"vote_output_csv_missing_vote_count: {vote_info['missing_vote_count']}")
